...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card pt-3">
                <img src="{{ asset($avatar->path) }}" class="card-img-top" alt="{{ $avatar->name }}" style="height: 200px; object-fit: contain;">
                <div class="card-body text-center">
                    ...
                    @if (Auth::user()->coin >= $avatar->price)
                        <form method="POST" action="{{ route('purchaseAvatar', ['avatar_id'=>$avatar->id]) }}">
                            @csrf
                            <button type="submit" class="btn btn-success btn-sm">@lang('lang.buy_now')</button>
                        </form>
                    @else
