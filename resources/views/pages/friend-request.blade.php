                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex justify-content-start gap-2">
                                                    <form method="POST" action="{{ route('acceptFriend', ['sender_id'=>$user->id]) }}" class="w-50">
                                                        @csrf
                                                        <button type="submit" class="btn btn-success btn-block d-flex align-items-center justify-content-center">Accept</button>
                                                    </form>
                                                    <form method="POST" action="{{ route('rejectFriend', ['sender_id'=>$user->id]) }}" class="w-50">
                                                        @csrf
                                                        <button type="submit" class="btn btn-danger btn-block d-flex align-items-center justify-content-center">Reject</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
